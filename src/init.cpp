    ...
    try
    {
        ...
        if (mapArgs.count("-?") || mapArgs.count("--help"))
        {
            ...
            std::string strUsage = _("bitmillion version") + " " + FormatFullVersion() + "\n\n" +
                _("Usage:") + "\n" +
                  "  bitmillion [options]                     " + "\n" +
                  "  bitmillion [options] <command> [params]  " + _("Send command to -server or bitmillion") + "\n" +
                  "  bitmillion [options] help                " + _("List commands") + "\n" +
                  "  bitmillion [options] help <command>      " + _("Get help for a command") + "\n";
...
std::string HelpMessage()
{
    string strUsage = _("Options:") + "\n" +
        ...
        "  -pid=<file>            " + _("Specify pid file (default: bitmillion.pid)") + "\n" +
